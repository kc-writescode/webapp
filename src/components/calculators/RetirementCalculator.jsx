      ...
      <Card title="Retirement Planning Details" icon={Landmark}>
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">{formatCurrency(monthlyExpenses)} per month</p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              {inflationRate}% per annum (India average: 5-7%)
            </p>
          </div>
          ...
          <div>
            ...
            <Input
              ...
              max="100"
            />
            <p className="text-xs text-slate-400 mt-1">{lifeExpectancy} years</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card variant="gradient" hover>
              <div className="text-center">
                ...
                <p className="text-xs text-slate-400 mt-1">@ {inflationRate}% inflation</p>
              </div>
            </Card>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                  ...
                  <p className="text-3xl font-bold text-white">{retirementAge - currentAge}</p>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg">
                    ...
                    <span className="text-xl font-bold text-emerald-400">
                      {formatCurrency(Math.round(results.corpusNeeded / ((Math.pow(1.12, retirementAge - currentAge) - 1) / 0.12 * 12)))}
                    </span>
                  </div>
